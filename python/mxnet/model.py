...
#xym add this to record the params information
#	f = open("/home/hadoop/tensor/data_trace/key_value.txt","a")
#	print("name_key: = ",name," index: = ", index, file = f)
#	print("=============== grad_list ===========\n", grad_list, file = f)
#	print("=============== Type_grad_list:\t", type(grad_list), file = f)
#	print("*************** arg_list ============\n", arg_list, file = f)
#	print("*************** Type_arg_list:\t", type(arg_list), file = f)
#	f.close()
#    f =  open("/home/hadoop/tensor/data_trace/key_value.txt","a")
#    print("~~~~~~~~~~~~~~~~~~~ Round Over ~~~~~~~~~~~~~~~~~~~~~\n", file = f)
#    f.close()
