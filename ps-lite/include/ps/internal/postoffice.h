...
//=============================== xym edit 2017-12-11 =============================//
  int my_rank() {send_id = 0; send_id = IDtoRank(van_->my_node().id); return send_id;}
  int send_id_() { return send_id;}//xym edit this -- 2017-12-11
 ...
 private:
  ...
  int send_id; //xym edit -- 2017-12-11
  bool barrier_done_;
  int verbose_;
