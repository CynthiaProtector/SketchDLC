...
struct Meta {
  ...
  /** \brief record the push_pull_operation*/
  int push_pull_operation; //xym add this-2017-12-11 
  /** \brief record the key to get back by meta */
  int recv_key; // xym add this 2018-01-02
